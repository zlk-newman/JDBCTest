...
public class db2Test {
    ...
    public void testQuery3() {
        // 3 准备sql语句
        String strSql = "select * from role1";
        // 调用DBDriver的查询方法，获取查询结果集（List+Map）
        List<RoleBean> lst = db2.queryListBean_Old(strSql);
        // 遍历结果集
    ...
    public void testQuery2() {
        ...
        // 调用DBDriver的查询方法，获取查询结果集（List+Map）
        List<Map<String, Object>> lst = db2.queryListMap(strSql);
        // 遍历结果集
        // 遍历行，list中的一个map就是一行数据
    ...
    public void testQuery4() {
        ...
        String strSql = "select * from role1";
        // 调用DBDriver的查询方法，获取查询结果集（List+Map）
        List<RoleBean> lst = dbd.queryListBean(strSql, RoleBean.class);
        // 遍历结果集
        // 遍历行，list中的一个map就是一行数据
        for (RoleBean en : lst) {
            // 打印每一行的实体类的信息
